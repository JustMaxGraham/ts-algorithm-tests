...
binary representation 1111 and has no binary gaps. The number 32 has binary representation 100000 and has no 
binary gaps.
...
function binaryGap(N) {
  ...
  const binaryGaps = binary.match(regex);

  if (binaryGaps !== null) {
    const longest = binaryGaps.reduce((a, b) => {
